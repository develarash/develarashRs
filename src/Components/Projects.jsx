...
import {getProjects} from "../Components/api_main/api"
...
useEffect(()=>{
  getProjects(Cookies.get('usert')).then((res)=>{

    setResetInput(res.data)
    // console.log(res)
...
<p className="upPrg">* This section is not an update *</p>
      ...
      {resetInput.length > 0 ? (        <button className="howMore" onClick={showMoreItems}>Show more</button>
